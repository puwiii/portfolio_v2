export const projects = [
    ...
    images: [
      {
        ...
        src: "/images/projects/lizaDecks.jpeg",
        alt: "Liza - Home",
      },
      {
        srchd: "/images/projects/originals/lizaLogin.jpeg",
        src: "/images/projects/lizaLogin.jpeg",
        alt: "Liza - Login",
      },
    ],
  },
  {
    id: 2,
    title: "Climapp",
    subtitle: "Facil, Rapido e Intuitivo",

    description: [
      `Climapp es una aplicación que te proporciona datos del clima en cualquier ciudad del mundo. Alimentado por la API "Open Weather Api", Climapp te ofrece el estado del clima detalladas en las próximas 48 horas y con información general en los próximos ocho (8) días.`,
    ],
    ...
    images: [
      {
        ...
        src: "/images/projects/climappHome.jpeg",
        alt: "Climapp - Home",
      },
      {
        srchd: "/images/projects/originals/climappDetails.jpeg",
        src: "/images/projects/climappDetails.jpeg",
        alt: "Climapp - Details",
      },
    ],
  },
  {
    id: 3,
    title: "Cinefan",
    subtitle: "Community - Easy - Useful",
    description: [
      "Cinefan es una aplicación donde puedes encontrar las listas de las películas o series del momento, las más votadas o las más vistas.",
      "También te ofrece un abanico de información acerca de una película o serie en particular. Cinefan provee una lista de trailers, comentarios de la comunidad y en caso de que te interese puedes ver una lista de recomendadas o relacionadas a la película o show que estés viendo.",
    ],
    githubLink:
    ...
    images: [
      {
        ...
        src: "/images/projects/cinefanHome.jpeg",
        alt: "Cinefan - Home",
      },
      {
        srchd: "/images/projects/originals/cinefanDetails.jpeg",
        src: "/images/projects/cinefanDetails.jpeg",
        alt: "Cinefan - Details",
      },
    ],
  },
